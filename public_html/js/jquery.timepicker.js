...
(function (factory) {
	...
	var methods =
	{
		init: function(options)
		{
			return this.each(function()
			{
				...
				for (var key in $.fn.simpletimepicker.defaults) {
					if (self.data(key))  {
						attributeOptions[key] = self.data(key);
					}
				}

				var settings = $.extend({}, $.fn.simpletimepicker.defaults, attributeOptions, options);
	...
	{
		if (this.value === '' || origin == 'simpletimepicker') {
			return;
		}
	...
	*/
	...
	// Plugin entry
	$.fn.simpletimepicker = function(method)
	{
