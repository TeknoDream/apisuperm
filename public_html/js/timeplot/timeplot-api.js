...
(function() {
    ...
    var loadTimeplot = function() {
        ...
        var timeplotURLPrefix = (local) ? "/js/timeplot/" : Timeplot.urlPrefix;
    ...
    var loadTimeline = function() {
        if (typeof Timeline != "undefined") {
            ...
            var timelineURL = (local) ? "/js/timeline/timeline-api.js?bundle=false" : "";
    ...
    if (typeof SimileAjax == "undefined") {
        ...
        var url = local ?
            "/js/ajax/simile-ajax-api.js?bundle=false" :
            "";
