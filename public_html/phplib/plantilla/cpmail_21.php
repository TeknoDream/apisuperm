...
$css_Tabla_Imagen='background-color: #CCC;padding:5px 0';	

$css_Tabla='background-color: #FFFFFF;padding:0px;font-family: \'Helvetica Neue\', Helvetica, Arial, sans-serif; border:1px solid #999;';	
